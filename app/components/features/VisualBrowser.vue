...
<template>
    <div class="relative group">
        <div
            class="relative bg-white dark:bg-neutral-800 rounded-xl overflow-hidden shadow-sm border border-neutral-200 dark:border-neutral-700">
            <!-- Browser Chrome -->
            <div class="flex items-center gap-3 bg-neutral-100 dark:bg-neutral-800 px-4 py-2.5 border-b border-neutral-200 dark:border-neutral-700">
