    ...
    <section class="py-10 sm:py-16 md:py-24 relative overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
                ...
                <!-- Title -->
                <h3
                    class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-gray-800 dark:text-white mb-3 sm:mb-4 md:mb-6">
                    {{ title }}
                </h3>

                <!-- Subtitle -->
                <p
                    class="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl mx-auto mb-6 sm:mb-8 md:mb-10">
                    {{ subtitle }}
                </p>

                <!-- Button -->
                <a :href="buttonUrl" target="_blank" rel="noopener noreferrer"
                    class="inline-flex items-center gap-2 sm:gap-3 px-6 py-3 sm:px-8 sm:py-4 bg-blue-600 text-white rounded-lg sm:rounded-xl font-semibold hover:bg-blue-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5">
                    {{ buttonText }}
