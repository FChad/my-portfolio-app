...
<template>
    <!-- Footer -->
    <footer class="border-t border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 relative">
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <NuxtLink to="https://github.com/FChad" external target="_blank"
                            aria-label="GitHub"
                            class="w-10 h-10 flex items-center justify-center rounded-lg bg-neutral-200 dark:bg-neutral-700 hover:bg-blue-600 dark:hover:bg-blue-500 text-neutral-700 dark:text-neutral-300 hover:text-white dark:hover:text-white transition-all duration-300">
                ...
                <!-- Navigation Section -->
                <div>
                    <h4 class="font-semibold text-neutral-900 dark:text-white mb-4">{{ $t('footer.navigation') }}</h4>
                    <ul class="grid grid-cols-2 gap-x-8 gap-y-3">
                        <li>
                            <NuxtLinkLocale to="/"
                                class="text-base text-neutral-600 dark:text-neutral-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors inline-flex items-center gap-2">
            ...
            <div class="pt-8 border-t border-neutral-200 dark:border-neutral-700">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    <p class="text-base text-neutral-600 dark:text-neutral-400 text-center md:text-left">
