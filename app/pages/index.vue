...
<template>
    ...
    <section id="about-section" class="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-16">
        <!-- Section Header -->
    ...
    <section class="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-16">
        <div class="text-center flex flex-col gap-4">
            <h2 class="text-4xl md:text-5xl font-black text-blue-600 dark:text-blue-400">
