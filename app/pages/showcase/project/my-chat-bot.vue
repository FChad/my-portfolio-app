...
<template>
    <div class="w-full">
        <!-- Navigation -->
        <UiSubNavigation :title="t('showcase.projects.myChatBot.title')" />
            ...
            <div class="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 pt-4 sm:pt-6 md:pt-8 pb-8 sm:pb-12">
                <div class="text-center max-w-4xl mx-auto">
                    ...
                    <div class="flex flex-wrap gap-2 sm:gap-3 justify-center px-4">
                        <span
                            v-for="tag in ['Nuxt3', 'Vue3', 'TypeScript', 'Pinia', 'Tailwind', 'Ollama', 'AI', 'Chat']"
                            :key="tag"
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-16">
                ...
                <div class="mb-12 sm:mb-16">
                    <div class="text-center mb-8 sm:mb-12">
                        <h2
                            ...
                            {{ t('projects.myChatBot.keyFeatures.title') }}</h2>
                ...
                <div class="mb-12 sm:mb-16">
                    <div class="text-center mb-8 sm:mb-12">
                        <h2
                            class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-200 mb-3 sm:mb-4">
                            {{ t('projects.myChatBot.builtWith.title') }}</h2>
                        <p class="text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto px-4">
