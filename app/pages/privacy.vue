    ...
    <div class="min-h-screen py-16 lg:py-24">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-10">
                <!-- Introduction -->
                <section
                    class="bg-white dark:bg-neutral-800 rounded-2xl p-6 sm:p-8 shadow-lg border border-neutral-200 dark:border-neutral-700">
                    <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4 flex items-center gap-3">
                        <Icon name="mdi:information" class="w-6 h-6 text-blue-600 dark:text-blue-400" />
                ...
                <section
                    class="bg-white dark:bg-neutral-800 rounded-2xl p-6 sm:p-8 shadow-lg border border-neutral-200 dark:border-neutral-700">
                    <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4 flex items-center gap-3">
                        <Icon name="mdi:account-tie" class="w-6 h-6 text-blue-600 dark:text-blue-400" />
                        {{ $t('privacy.sections.responsible.title') }}
                    </h2>
                    <div class="text-neutral-600 dark:text-neutral-400 leading-relaxed space-y-1">
                        <p class="font-medium text-neutral-900 dark:text-white">Chad Feierstein</p>
                ...
                <section
                    class="bg-white dark:bg-neutral-800 rounded-2xl p-6 sm:p-8 shadow-lg border border-neutral-200 dark:border-neutral-700">
                    <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4 flex items-center gap-3">
                        <Icon name="mdi:database" class="w-6 h-6 text-blue-600 dark:text-blue-400" />
                ...
                <section
                    class="bg-white dark:bg-neutral-800 rounded-2xl p-6 sm:p-8 shadow-lg border border-neutral-200 dark:border-neutral-700">
                    <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4 flex items-center gap-3">
                        <Icon name="mdi:cog" class="w-6 h-6 text-blue-600 dark:text-blue-400" />
                        {{ $t('privacy.sections.technicalStorage.title') }}
                    </h2>
                    <p class="text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6">
                        {{ $t('privacy.sections.technicalStorage.content') }}
                    </p>

                    <!-- localStorage Item -->
                    <div
                        class="bg-neutral-50 dark:bg-neutral-900/50 rounded-xl p-4 mb-4 border border-neutral-200 dark:border-neutral-600">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <span
                                ...
                                {{ $t('privacy.sections.technicalStorage.localStorage.badge') }}
                            </span>
                        </div>
                        <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-2">
                            {{ $t('privacy.sections.technicalStorage.localStorage.description') }}
                        </p>
                        <div
                            class="text-xs text-neutral-500 dark:text-neutral-500 font-mono bg-neutral-100 dark:bg-neutral-800 rounded px-2 py-1 inline-block">
                            Key: nuxt-color-mode
                        </div>
                    </div>
                    ...
                    <!-- Turnstile Item -->
                    <div
                        class="bg-neutral-50 dark:bg-neutral-900/50 rounded-xl p-4 border border-neutral-200 dark:border-neutral-600">
                        <div class="flex items-center gap-3 mb-2">
                ...
                <section
                    class="bg-white dark:bg-neutral-800 rounded-2xl p-6 sm:p-8 shadow-lg border border-neutral-200 dark:border-neutral-700">
                    <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4 flex items-center gap-3">
                        <Icon name="mdi:email-outline" class="w-6 h-6 text-blue-600 dark:text-blue-400" />
                        {{ $t('privacy.sections.contactForm.title') }}
                    </h2>
                    <p class="text-neutral-600 dark:text-neutral-400 leading-relaxed mb-4">
                        {{ $t('privacy.sections.contactForm.content') }}
                    </p>
                    <ul class="space-y-2 text-neutral-600 dark:text-neutral-400">
                        <li class="flex items-start gap-2">
                            <Icon name="mdi:circle-small" class="w-5 h-5 text-neutral-400 mt-0.5 shrink-0" />
                    ...
                    <!-- Resend Info -->
                    <div
                        class="mt-6 bg-neutral-50 dark:bg-neutral-900/50 rounded-xl p-4 border border-neutral-200 dark:border-neutral-600">
                        <div class="flex items-center gap-3 mb-2">
                            <Icon name="mdi:email-fast" class="w-5 h-5 text-blue-500" />
                            <h3 class="font-medium text-neutral-900 dark:text-white">
                ...
                <section
                    class="bg-white dark:bg-neutral-800 rounded-2xl p-6 sm:p-8 shadow-lg border border-neutral-200 dark:border-neutral-700">
                    <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4 flex items-center gap-3">
                        <Icon name="mdi:cloud" class="w-6 h-6 text-blue-600 dark:text-blue-400" />
                ...
                <section
                    class="bg-white dark:bg-neutral-800 rounded-2xl p-6 sm:p-8 shadow-lg border border-neutral-200 dark:border-neutral-700">
                    <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4 flex items-center gap-3">
                        <Icon name="mdi:scale-balance" class="w-6 h-6 text-blue-600 dark:text-blue-400" />
                ...
                <section
                    class="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6 sm:p-8 border border-blue-200 dark:border-blue-800">
                    <div class="flex items-start gap-4">
                        <div
                            class="shrink-0 w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center">
                            <Icon name="mdi:cookie-off" class="w-6 h-6 text-blue-600 dark:text-blue-400" />
                        </div>
                        <div>
                            ...
                            <p class="text-neutral-600 dark:text-neutral-400 leading-relaxed">
                                {{ $t('privacy.sections.noCookieBanner.content') }}
                            </p>
                        </div>
                    </div>
                </section>
            ...
            <div class="mt-12 text-center">
                <NuxtLinkLocale to="/"
                    class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-medium transition-colors">
